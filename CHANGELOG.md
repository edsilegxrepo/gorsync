...
- **Module & Cmd Restructuring**: Updated Go module path to `github.com/edsilegxrepo/gorsync` and reorganized binary executables into standard Go layout (`cmd/rsync/main.go` and `cmd/rsyncd/main.go`).
